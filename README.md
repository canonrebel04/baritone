...
**Note for Developers:** Baritone 1.21+ uses a modular Gradle architecture. See [SETUP.md](SETUP.md) for details on the new project structure (Core, API, Fabric, etc.) and build instructions.
